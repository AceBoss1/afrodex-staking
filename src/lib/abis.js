...
// full ABI (the large array you provided). Paste the ABI JSON you posted here.
// For brevity I've included the important pieces below — replace or extend if you have an updated ABI file.
...
// For safety (some providers expect the token ABI for token reads), export a token ABI too.
export const AFROX_TOKEN_ABI = STAKING_ABI;
